"""
Comando Django para monitorar logs da catraca em tempo real.
"""
import time
import json
...
class Command(BaseCommand):
    help = 'Monitora logs da catraca em tempo real'
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            type=int,
            default=1,
            help='Intervalo de verificação em segundos (padrão: 1)',
        )
        parser.add_argument(
            '--limit',
            type=int,
            default=50,
            help='Limite de logs por verificação (padrão: 50, máximo: 100)',
        )
        parser.add_argument(
            '--device-id',
            type=int,
    ...
    def handle(self, *args, **options):
        self.stdout.write("🔍 Iniciando monitoramento de logs da catraca...")
