"""
Comando Django para resetar e carregar apenas o último log.
"""
...
class Command(BaseCommand):
    help = 'Reseta todos os logs e carrega apenas o último log da catraca'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("🔄 RESETANDO E CARREGANDO APENAS O ÚLTIMO LOG")
        ...
        try:
            ...
            # 4. Buscar apenas o último log
            self.stdout.write("\n4️⃣ Buscando último log...")
            ...
            # 5. Processar apenas o último log
            self.stdout.write("\n5️⃣ Processando último log...")
